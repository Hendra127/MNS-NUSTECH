...
<head>
    ...
    <style>
        ...
        * {
        ...
        .mk-main::-webkit-scrollbar-thumb {
            background: var(--border);
            border-radius: 3px;
        }
        ...
        .fill-disk {
            background: linear-gradient(90deg, var(--accent-warn), #f97316);
        }
        ...
        #placeholder-no-site h2 {
            font-size: 22px;
            color: var(--text-secondary);
            margin-bottom: 8px;
        }

        #placeholder-no-site p {
            font-size: 14px;
            color: var(--text-muted);
            max-width: 400px;
        }
...
<body>
    ...
    <div class="mk-layout">
        ...
        <main class="mk-main" id="mk-main">
            ...
            <div id="placeholder-no-site">
                ...
                <p>Pilih site dari dropdown di sebelah kiri, lalu klik <strong
                        style="color:var(--accent)">Hubungkan</strong> untuk mulai mengelola MikroTik.</p>
            </div>
            ...
            <div class="content-section" id="section-dashboard">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="refreshDashboard()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-danger btn-sm" onclick="confirmReboot()" id="btn-reboot"><i
                                class="fas fa-power-off"></i> Reboot</button>
                    </div>
                </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="progress-bar-wrap">
                            <div class="progress-bar">
                                <div class="progress-bar-fill fill-cpu" id="d-cpu-bar" style="width:0%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="progress-bar-wrap">
                            <div class="progress-bar">
                                <div class="progress-bar-fill fill-ram" id="d-ram-bar" style="width:0%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="progress-bar-wrap">
                            <div class="progress-bar">
                                <div class="progress-bar-fill fill-disk" id="d-hdd-bar" style="width:0%"></div>
                            </div>
                        </div>
                    </div>
                    <div class="stat-card">
                ...
                <div class="data-table-wrap">
                    <div class="data-table-header">
                        <div class="data-table-title"><i class="fas fa-info-circle" style="color:var(--accent)"></i>
                            Informasi Sistem</div>
                        <button class="btn btn-secondary btn-sm" onclick="openIdentityModal()"><i
                                class="fas fa-edit"></i> Edit Identity</button>
                    </div>
                    <table>
                        <tbody id="system-info-table">
                            <tr>
                                <td colspan="2" style="text-align:center;color:var(--text-muted);padding:24px">Belum
                                    terhubung</td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="content-section" id="section-interface">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadInterfaces()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="iface-interfaces">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-ethernet" style="color:var(--accent)"></i>
                                Daftar Interface</div>
                        </div>
                                ...
                                <tbody id="interface-table-body">
                                    <tr>
                                        <td colspan="7" class="text-center"
                                            style="padding:24px;color:var(--text-muted)">Loading...</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="sub-content" id="iface-vlans">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-layer-group" style="color:var(--accent)"></i>
                                VLAN</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddVlanModal()"><i
                                    class="fas fa-plus"></i> Tambah VLAN</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
                                ...
                                <tbody id="vlan-table-body">
                                    <tr>
                                        <td colspan="5" style="padding:24px;color:var(--text-muted);text-align:center">
                                            Loading...</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="sub-content" id="iface-bridges">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-sitemap" style="color:var(--accent)"></i>
                                Bridge & Bridge Ports</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
                                ...
                                <tbody id="bridge-table-body">
                                    <tr>
                                        <td colspan="4" style="padding:24px;color:var(--text-muted);text-align:center">
                                            Loading...</td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div class="content-section" id="section-ip">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="loadIpAddresses()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-primary" onclick="openAddIpModal()"><i class="fas fa-plus"></i> Tambah
                            IP</button>
                    </div>
                </div>
                <div class="data-table-wrap">
            ...
            <div class="content-section" id="section-route">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="loadRoutes()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-primary" onclick="openAddRouteModal()"><i class="fas fa-plus"></i> Tambah
                            Route</button>
                    </div>
                </div>
                <div class="data-table-wrap">
            ...
            <div class="content-section" id="section-dhcp">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadDhcp()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="dhcp-servers">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-hdd" style="color:var(--accent)"></i> DHCP
                                Servers</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                ...
                <div class="sub-content" id="dhcp-leases">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-list" style="color:var(--accent)"></i> Active
                                Leases</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddLeaseModal()"><i
                                    class="fas fa-plus"></i> Tambah Static</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
                ...
                <div class="sub-content" id="dhcp-networks">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-project-diagram"
                                    style="color:var(--accent)"></i> DHCP Networks</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
            ...
            <div class="content-section" id="section-dns">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadDns()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <!-- DNS Config -->
                <div class="data-table-wrap" style="margin-bottom:16px">
                    <div class="data-table-header">
                        <div class="data-table-title"><i class="fas fa-sliders-h" style="color:var(--accent)"></i>
                            Konfigurasi DNS</div>
                        <button class="btn btn-primary btn-sm" onclick="saveDnsSettings()"><i class="fas fa-save"></i>
                            Simpan</button>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group" style="display:flex;align-items:flex-end;gap:12px">
                                <div>
                                    ...
                                    <label class="toggle-switch"><input type="checkbox" id="dns-allow-remote"><span
                ...
                <div class="data-table-wrap">
                    <div class="data-table-header">
                        <div class="data-table-title"><i class="fas fa-list" style="color:var(--accent)"></i> Static DNS
                            Entries</div>
                        <button class="btn btn-primary btn-sm" onclick="openAddDnsStaticModal()"><i
            ...
            <div class="content-section" id="section-firewall">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadFirewall()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="fw-filter">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-filter" style="color:var(--accent)"></i>
                                Filter Rules</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddFirewallModal('filter')"><i
                                    class="fas fa-plus"></i> Tambah Rule</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
                ...
                <div class="sub-content" id="fw-nat">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-exchange-alt"
                                    style="color:var(--accent)"></i> NAT Rules</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddFirewallModal('nat')"><i
                                    class="fas fa-plus"></i> Tambah Rule</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                ...
                <div class="sub-content" id="fw-mangle">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-wrench" style="color:var(--accent)"></i>
                                Mangle Rules</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                ...
                <div class="sub-content" id="fw-addrlist">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-list-ul" style="color:var(--accent)"></i>
                                Address Lists</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddAddressListModal()"><i
                                    class="fas fa-plus"></i> Tambah</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
            ...
            <div class="content-section" id="section-wireless">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadWireless()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="wl-interfaces">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-wifi" style="color:var(--accent)"></i>
                                Wireless Interfaces</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
                ...
                <div class="sub-content" id="wl-registrations">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-laptop" style="color:var(--accent)"></i>
                                Klien Terhubung</div>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                ...
                <div class="sub-content" id="wl-security">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-lock" style="color:var(--accent)"></i>
            ...
            <div class="content-section" id="section-users">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="loadUsers()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-primary" onclick="openAddUserModal()"><i class="fas fa-user-plus"></i>
                            Tambah User</button>
                    </div>
                </div>
                <div class="sub-tabs">
            ...
            <div class="content-section" id="section-queue">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="loadQueues()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-primary" onclick="openAddQueueModal()"><i class="fas fa-plus"></i> Tambah
                            Queue</button>
                    </div>
                </div>
                <div class="data-table-wrap">
            ...
            <div class="content-section" id="section-ppp">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadPpp()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="ppp-secrets">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-key" style="color:var(--accent)"></i> PPP
                                Secrets</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddPppModal()"><i
                                    class="fas fa-plus"></i> Tambah Secret</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
                                <thead>
            ...
            <div class="content-section" id="section-hotspot">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadHotspot()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content active" id="hs-users">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-user-circle" style="color:var(--accent)"></i>
                                Hotspot Users</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddHotspotUserModal()"><i
            ...
            <div class="content-section" id="section-services">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadServices()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="data-table-wrap">
                    <div style="overflow-x:auto">
            ...
            <div class="content-section" id="section-arp">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadArp()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="sub-tabs">
            ...
            <div class="content-section" id="section-scripts">
                <div class="section-header">
                    ...
                    <div style="display:flex;gap:8px">
                        <button class="btn btn-secondary" onclick="loadScripts()"><i class="fas fa-sync-alt"></i>
                            Refresh</button>
                        <button class="btn btn-primary" onclick="openAddScriptModal()"><i class="fas fa-plus"></i>
                            Tambah Script</button>
                    </div>
                </div>
                <div class="sub-tabs">
                ...
                <div class="sub-content" id="sc-schedulers">
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-clock" style="color:var(--accent)"></i>
                                Schedulers</div>
                            <button class="btn btn-primary btn-sm" onclick="openAddSchedulerModal()"><i
                                    class="fas fa-plus"></i> Tambah</button>
                        </div>
                        <div style="overflow-x:auto">
                            <table>
            ...
            <div class="content-section" id="section-backup">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadFiles()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <!-- Create Backup -->
                <div class="data-table-wrap" style="margin-bottom:16px">
                    <div class="data-table-header">
                        <div class="data-table-title"><i class="fas fa-save" style="color:var(--accent)"></i> Buat
                            Backup</div>
                    </div>
                    <div style="padding:16px;display:flex;align-items:flex-end;gap:10px">
                        ...
                        <button class="btn btn-primary" onclick="createBackup()"><i class="fas fa-save"></i> Buat
                            Backup</button>
                    </div>
                </div>
                <!-- Files list -->
                <div class="data-table-wrap">
                    <div class="data-table-header">
                        <div class="data-table-title"><i class="fas fa-folder" style="color:var(--accent)"></i> File
                            Manager</div>
                    </div>
                    <div style="overflow-x:auto">
                        <table>
            ...
            <div class="content-section" id="section-tools">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
                    ...
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-satellite-dish"
                                    style="color:var(--accent)"></i> Ping</div>
                        </div>
                        <div style="padding:16px">
                            <div class="form-group">
                                ...
                                <div style="display:flex;gap:8px">
                                    ...
                                    <button class="btn btn-primary" onclick="runPing()"><i
                                            class="fas fa-play"></i></button>
                                </div>
                            </div>
                            <div class="ping-result" id="ping-result">Masukkan alamat IP kemudian klik tombol play...
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="data-table-wrap">
                        <div class="data-table-header">
                            <div class="data-table-title"><i class="fas fa-chart-line" style="color:var(--accent)"></i>
                                Traffic Monitor</div>
                        </div>
                        <div style="padding:16px">
                            <div class="form-group">
                                ...
                                <div style="display:flex;gap:8px">
                                    ...
                                    <button class="btn btn-primary" onclick="checkTraffic()"><i
                                            class="fas fa-play"></i></button>
                                </div>
                            </div>
            ...
            <div class="content-section" id="section-log">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadSystemLog()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
            ...
            <div class="content-section" id="section-auditlog">
                <div class="section-header">
                    ...
                    <button class="btn btn-secondary" onclick="loadAuditLog()"><i class="fas fa-sync-alt"></i>
                        Refresh</button>
                </div>
                <div class="data-table-wrap">
                    <div style="overflow-x:auto">
    ...
    <div class="modal-overlay" id="modal-credentials">
        <div class="modal">
            ...
            <div class="alert alert-info"><i class="fas fa-info-circle"></i> Pastikan RouterOS API aktif di MikroTik (IP
                → Services → api, port 8728)</div>
            <div class="form-row">
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="testConnectionModal()"><i class="fas fa-plug"></i> Test
                    Koneksi</button>
    ...
    <div class="modal-overlay" id="modal-add-dns">
        <div class="modal" style="max-width:420px">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveAddDnsStatic()"><i class="fas fa-save"></i>
                    Tambahkan</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-add-fw">
        <div class="modal modal-lg">
            <div class="modal-header">
                <div class="modal-title" id="fw-modal-title"><i class="fas fa-shield-alt"></i> Tambah Firewall Rule
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="fw-action">
                        ...
                        <option>src-nat</option>
                        <option>mark-packet</option>
                        <option>mark-connection</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveFirewallRule()"><i class="fas fa-save"></i>
                    Tambahkan</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-add-hs-user">
        <div class="modal" style="max-width:460px">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveAddHotspotUser()"><i class="fas fa-save"></i>
                    Tambahkan</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-add-script">
        <div class="modal modal-lg">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="sc-policy"
                    value="ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon">
            </div>
            <div class="form-group">
                <label class="form-label">Source (RouterOS Script)</label>
                <textarea class="script-editor" id="sc-source"
                    placeholder=":log info message=&quot;Hello from script&quot;"></textarea>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="closeModal('modal-add-script')">Batal</button>
                <button class="btn btn-primary" onclick="saveAddScript()"><i class="fas fa-save"></i> Simpan
                    Script</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-add-scheduler">
        <div class="modal" style="max-width:500px">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveAddScheduler()"><i class="fas fa-save"></i>
                    Tambahkan</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-add-addrlist">
        <div class="modal" style="max-width:420px">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveAddAddressList()"><i class="fas fa-save"></i>
                    Tambahkan</button>
            </div>
        </div>
    </div>
