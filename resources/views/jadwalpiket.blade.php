    ...
    <style>
        * {
        ...
        select.shift-box {
            ...
            /* firefox */
            line-height: 22px;
            /* = height → teks vertikal tengah */
        }

        select.shift-box:focus {
            outline: none;
        }

        select.shift-box option {
            text-align: center;
        }
        ...
        /* Warna shift */
        .bg-p {
            background-color: var(--color-pagi) !important;
        }

        .bg-s {
            background-color: var(--color-siang) !important;
        }

        .bg-m {
            background-color: var(--color-malam) !important;
            color: #333 !important;
        }
    ...
    <div class="container-fluid px-4">
        ...
        <div id="capture-area">
            <div class="report-header">
                ...
                <div class="text-muted small mt-1">Bulan: {{ $bulanSekarang }} {{ $tahunSekarang }} | NUSTECH Indonesia
                </div>
            </div>
            ...
            <div class="legend-area">
                <div class="legend-item">
                    <div class="dot bg-p"></div> Pagi (P)
                </div>
                <div class="legend-item">
                    <div class="dot bg-s"></div> Siang (S)
                </div>
                <div class="legend-item">
                    <div class="dot bg-m"></div> Malam (M)
                </div>
                <div class="legend-item">
                    <div class="dot bg-off"></div> Libur (OFF)
                </div>
            </div>
        </div>
    </div>
