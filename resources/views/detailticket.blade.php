...
<body>
            ...
            <div class="user-profile-wrapper" style="position: relative;">
                ...
                <div id="profileDropdownMenu" class="hidden"
                    ...
                    <form action="{{ route('logout') }}" method="POST" id="logout-form">
                        @csrf
                        <button type="submit"
                            style="width: 100%; text-align: left; padding: 10px 15px; background: none; border: none; font-size: 14px; color: #333; cursor: pointer; display: flex; align-items: center; transition: background 0.2s;"
                            onmouseover="this.style.backgroundColor='#f5f5f5'"
                            onmouseout="this.style.backgroundColor='transparent'">
    ...
    <div class="tabs-section d-flex align-items-center">
        <a href="{{ url('/open-ticket') }}" class="tab {{ request()->is('open-ticket*') ? 'active' : '' }}"
            style="text-decoration: none; color: {{ request()->is('open-ticket*') ? 'White' : 'Black' }};">Open
            Tiket</a>
        <a href="{{ url('/close-ticket') }}" class="tab {{ request()->is('close-ticket*') ? 'active' : '' }}"
            style="text-decoration: none; color: {{ request()->is('close-ticket*') ? 'White' : 'Black' }};">Close
            Tiket</a>
        <a href="{{ url('/detailticket') }}" class="tab {{ request()->is('detailticket*') ? 'active' : '' }}"
            style="text-decoration: none; color: {{ request()->is('detailticket*') ? 'White' : 'Black' }};">Detail
            Tiket</a>
        <a href="{{ url('/summaryticket') }}" class="tab {{ request()->is('summaryticket*') ? 'active' : '' }}"
            style="text-decoration: none; color: {{ request()->is('summaryticket*') ? 'White' : 'Black' }};">Summary
            Tiket</a>
    </div>
                ...
                @forelse($openTickets as $t)
                    <div class="ticket-item">
                        ...
                        <div class="ticket-info">
                            ...
                            <div class="ticket-site-name">{{ $t->nama_site }} <span
                                    style="opacity: 0.4; font-weight: 300;">({{ $t->site_code }})</span></div>
                            <div class="ticket-meta">
                                <span class="meta-pill"><i class="bi bi-tag-fill me-1"></i>
                                    {{ strtoupper($t->kategori) }}</span>
                                <span class="meta-pill"><i class="bi bi-exclamation-triangle-fill me-1"></i>
                                    {{ $t->kendala ?? 'No Detail' }}</span>
                            </div>
                        </div>
                    </div>
                @empty
            ...
            <div
                ...
                <div class="card-header-actions">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <select id="cardFilterKategori" class="filter-input-card" style="width: 140px;"
                            onchange="applyCardFilter()">
        ...
        <div class="premium-card">
            ...
            <div class="insight-grid">
                ...
                <div class="metric-box">
                    ...
                    <div class="metric-value" id="valTopProblem"
                        style="font-size: 1rem; line-height: 1.2; height: 1.2em; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        {{ $topProblem }}</div>
            ...
            <div class="mt-4 p-3 rounded-4"
                ...
                <div class="progress" style="height: 8px; background: rgba(255,255,255,0.1); border-radius: 10px;">
                    <div class="progress-bar bg-info" id="progTotalTickets" role="progressbar"
                        style="width: {{ min(($totalTickets / 100) * 100, 100) }}%"></div>
                </div>
            </div>
        </div>
        {{-- CARD 4: BAR CHART --}}
