    ...
    <style>
        ...
        *::after {
        ...
        .mouth-bar:nth-child(1) {
            animation: mouthWave 0.8s ease-in-out infinite 0.0s;
        }

        .mouth-bar:nth-child(2) {
            animation: mouthWave 0.8s ease-in-out infinite 0.1s;
        }

        .mouth-bar:nth-child(3) {
            animation: mouthWave 0.8s ease-in-out infinite 0.2s;
        }

        .mouth-bar:nth-child(4) {
            animation: mouthWave 0.8s ease-in-out infinite 0.3s;
        }

        .mouth-bar:nth-child(5) {
            animation: mouthWave 0.8s ease-in-out infinite 0.4s;
        }
        ...
        .chest-led:nth-child(1) {
            background: #ff5252;
            box-shadow: 0 0 6px #ff5252;
            animation: chestBlink 1.5s ease-in-out infinite 0s;
        }

        .chest-led:nth-child(2) {
            background: #ffeb3b;
            box-shadow: 0 0 6px #ffeb3b;
            animation: chestBlink 1.5s ease-in-out infinite 0.5s;
        }

        .chest-led:nth-child(3) {
            background: #69f0ae;
            box-shadow: 0 0 6px #69f0ae;
            animation: chestBlink 1.5s ease-in-out infinite 1.0s;
        }
    ...
    <div class="login-wrapper">
        ...
        <div class="right-section">
            ...
            <div class="form-container">
                ...
                <form action="{{ route('login') }}" method="POST" class="@if($errors->any()) shake-horizontal @endif"
                    id="loginForm">
                    @csrf
                    ...
                    <div class="group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" id="emailInput" class="cyber-input"
                                placeholder="email@example.com" value="{{ old('email') }}" autocomplete="email"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" id="passwordInput" class="cyber-input"
